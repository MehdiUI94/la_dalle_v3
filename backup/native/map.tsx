...
// Import dynamique de react-native-maps (uniquement chargé à l'exécution)
// Utiliser require() pour éviter que le bundler web analyse ce code
// Note: react-native-maps nécessite un development build et ne fonctionne pas avec Expo Go
...
try {
  ...
  // react-native-maps n'est pas disponible (Expo Go ou erreur)
  console.warn('react-native-maps non disponible, utilisation du fallback')
}
...
export default function MapScreen() {
  ...
  // Fallback si MapView n'est pas disponible (Expo Go ou development build requis)
  if (!MapView) {
    return (
      <View style={styles.container}>
        ...
        <View style={styles.webFallback}>
          ...
          <Text style={styles.webFallbackTitle}>Carte non disponible</Text>
          <Text style={styles.webFallbackText}>
            La fonctionnalité de carte nécessite un development build.
          </Text>
          <Text style={styles.webFallbackText}>
          ...
          {restaurants.length > 0 && (
            <View style={styles.restaurantsList}>
              {restaurants.map((resto) => (
                ...
                >
                  <Text style={styles.restaurantCardName}>{resto.name}</Text>
